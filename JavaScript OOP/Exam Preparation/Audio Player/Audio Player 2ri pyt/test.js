...
let playable = new Playable('pesen', 'avtor');
let playable2 = new Playable('mnogo gotian pesen', 'neisvesten');
let playable3 = new Playable('koponq', 'azis');

let playLIst = new PlayList('playLIst');
let playLIst2 = new PlayList('newplayLIst');
let playLIst3 = new PlayList('oldplayLIst');

playLIst.addPlayable(playable);
playLIst.addPlayable(playable2);

playLIst2.addPlayable(playable);
playLIst2.addPlayable(playable3);

playLIst3.addPlayable(playable3);

let player = new Player('player');

player.addPlaylist(playLIst);
player.addPlaylist(playLIst2);
player.addPlaylist(playLIst3);

//console.log(player.playerContainer[1]);
let kk = player.search('pesen');
...
// 			arr.forEach(el => {
// 				      el.map(x => {
// 						  if(x.title.includes(pattern)){
// 							  result.push(this.playerContainer[el].name);
// 							  result.push(x);
// 						  }
// 					  });				
// 				});

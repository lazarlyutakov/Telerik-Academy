namespace ArmyOfCreatures.Logic.Creatures
{
    ...
    public abstract class Creature
    {
        ...
        public Creature(int attack, int defense, int healthPoints, decimal damage)
        {
            this.Attack = attack;
        ...
        // CHANGED FROM PROTECTED TO PUBLIC IN ORDER TO RUN SUCCESSFULLY UNIT TEST ! TRY TO DO IT WITH PROTECTED !

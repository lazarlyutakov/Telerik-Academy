...
{
    public abstract class MotorVehicle : IdentifiableObjects, IMotorVehicle, IWeightable, IValuable, IIdentifiable
    {
        ...
        public MotorVehicle(decimal price, int weight, int topSpeed, int acceleration) : base()
        {
            this.price = price;
            this.weight = weight;

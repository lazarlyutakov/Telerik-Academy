...
{
    public class ExtendedInterractionManager : InteractionManager
    {
        public ExtendedInterractionManager()
            : base()
        {
        }
        ...
        protected override Location CreateLocation(string locationTypeString, string locationName)
        {
            ...
            {
                case "forest":
                    return new Forest(locationName, LocationType.Forest);
                case "mine":
                    return new Mine(locationName, LocationType.Mine);
                default:
